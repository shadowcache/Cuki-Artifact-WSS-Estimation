...
#./datasets/benchmarks/memory-bmc/accuracy/msr/summary.csv
path="./datasets/benchmarks/"
bmc_file="./datasets/benchmarks/memory-bmc/accuracy/msr/summary.csv"
ccf_file="./datasets/benchmarks/memory-ccf/accuracy/msr/summary_false.csv"
ccfoa_file="./datasets/benchmarks/memory-ccf/accuracy/msr/summary_true.csv"
mbf_file="./datasets/benchmarks/memory-mbf/accuracy/msr/summary.csv"
ss_file="./datasets/benchmarks/memory-ss/accuracy/msr/summary.csv"
swamp_file="./datasets/benchmarks/swamp/accuracy/msr/summary.csv"
...
plt.legend()
plt.savefig('./plot/figs/msr_accuracy.pdf', bbox_inches='tight')
print('./plot/figs/msr_accuracy.pdf')